...
function CourseProgress() {
    ...
    //handle select a spicific lecture to watch
    ...
    return (
        <div className='max-w-7xl mx-auto p-4 mt-20'>
            ...
            <div className='flex justify-between mb-4'>
                ...
                >{completed ? <div className='flex items-center'><CheckCircle className='h-4 w-4 mr-2' /> <span>Completed</span></div> : "Mark as completed"}</Button>
            </div>
